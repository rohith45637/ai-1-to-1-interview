...
export function Modal({ isOpen, onClose, title, children, maxWidth = 'max-w-2xl' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 sm:p-6">
      ...
      <div className={'relative bg-white dark:bg-surface-900 rounded-2xl shadow-2xl border border-surface-200 dark:border-surface-800 w-full ' + maxWidth + ' p-6 overflow-hidden z-10 animate-in fade-in zoom-in-95 duration-150'}>
