    ...
    <div className="max-w-4xl mx-auto space-y-8 py-6 pb-24 text-surface-200">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        {activeSection === 'account' && (
          <Card className="p-6 space-y-5 border-surface-800 bg-surface-900/80">
            <div className="flex items-center gap-2 font-bold text-sm text-white pb-2 border-b border-surface-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1.5">
                <label className="font-semibold text-surface-300">Full Name</label>
                <input
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="w-full p-2.5 rounded-xl border border-surface-700 bg-surface-950 text-white focus:ring-2 focus:ring-brand-500 focus:outline-none"
                />
              </div>

              <div className="space-y-1.5">
                <label className="font-semibold text-surface-300">Email Address</label>
                <input
                  type="email"
                  value={email}
              ...
              <div className="space-y-1.5">
                <label className="font-semibold text-surface-300">Default Target Role</label>
                <input
                  type="text"
                  value={targetRole}
              ...
              <div className="space-y-1.5">
                <label className="font-semibold text-surface-300">Experience Tier</label>
                <select
                  value={experienceLevel}
                  onChange={(e) => setExperienceLevel(e.target.value)}
                  className="w-full p-2.5 rounded-xl border border-surface-700 bg-surface-950 text-white focus:ring-2 focus:ring-brand-500 focus:outline-none cursor-pointer"
                >
          ...
          <Card className="p-6 space-y-5 border-surface-800 bg-surface-900/80">
            ...
            <div className="flex items-center justify-between text-xs py-2">
              <div>
                ...
                <span className="text-surface-400">Toggle between Dark Mode and Light Mode</span>
              </div>
          ...
          <Card className="p-6 space-y-5 border-surface-800 bg-surface-900/80">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-center justify-between p-3 rounded-xl bg-surface-950 border border-surface-800">
                <div>
                  <span className="font-bold text-white block">Voice Accent</span>
                  <span className="text-surface-400">Indian English / Neutral English dialect prioritization</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-surface-950 border border-surface-800">
                <div>
                  <span className="font-bold text-white block">Speech Pacing</span>
                  <span className="text-surface-400">Calibrated at 0.90x for clear articulation</span>
                </div>
        ...
        {activeSection === 'privacy' && (
          <Card className="p-6 space-y-5 border-rose-500/30 bg-rose-950/10">
            <div className="flex items-center gap-2 font-bold text-sm text-rose-400 pb-2 border-b border-rose-900/40">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs">
              <div>
                <span className="font-bold text-white block">Reset All Interview Transcripts & Scores</span>
                <span className="text-surface-400">Clears past assessment logs, question critiques, and streak counts.</span>
              </div>
